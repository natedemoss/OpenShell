...
const file_openshell_proto_rawDesc = "" +
	...
	"7PROVIDER_CREDENTIAL_REFRESH_RECOVERY_ACTION_INVESTIGATE\x10\x042\xefJ\n" +
	"\tOpenShell\x12Z\n" +
...
var file_openshell_proto_goTypes = []any{
	...
	(*RelayOpen)(nil),                                    // 161: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                               // 162: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                               // 163: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                                    // 164: openshell.v1.RelayInit
	(*RelayFrame)(nil),                                   // 165: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                              // 166: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                                   // 167: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                              // 168: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                                // 169: openshell.v1.DenialSummary
	(*DenialGroupCount)(nil),                             // 170: openshell.v1.DenialGroupCount
	(*NetworkActivitySummary)(nil),                       // 171: openshell.v1.NetworkActivitySummary
	(*PolicyChunk)(nil),                                  // 172: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                            // 173: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),                  // 174: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),                 // 175: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                        // 176: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                       // 177: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),                     // 178: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),                    // 179: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),                      // 180: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),                     // 181: openshell.v1.RejectDraftChunkResponse
	(*DraftChunkApproval)(nil),                           // 182: openshell.v1.DraftChunkApproval
	...
	nil,                                                  // 218: openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	nil,                                                  // 219: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                  // 220: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                  // 221: openshell.v1.CreateSandboxRequest.AnnotationsEntry
	nil,                                                  // 222: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                                  // 223: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                                  // 224: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                                  // 225: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                                  // 226: openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	nil,                                                  // 227: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	nil,                                                  // 228: openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	nil,                                                  // 229: openshell.v1.ProviderProfile.AnnotationsEntry
	nil,                                                  // 230: openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	nil,                                                  // 231: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	nil,                                                  // 232: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	nil,                                                  // 233: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	nil,                                                  // 234: openshell.v1.UpdateConfigRequest.AnnotationsEntry
	nil,                                                  // 235: openshell.v1.UpdateConfigResponse.AnnotationsEntry
	nil,                                                  // 236: openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	nil,                                                  // 237: openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	nil,                                                  // 238: openshell.v1.StoredPolicyRevision.ProvenanceEntry
	...
	(*datamodelv1.CredentialHandle)(nil),                 // 245: openshell.datamodel.v1.CredentialHandle
	(*sandboxv1.NetworkEndpoint)(nil),                    // 246: openshell.sandbox.v1.NetworkEndpoint
	(*sandboxv1.NetworkBinary)(nil),                      // 247: openshell.sandbox.v1.NetworkBinary
	(*sandboxv1.SettingValue)(nil),                       // 248: openshell.sandbox.v1.SettingValue
	(*sandboxv1.NetworkPolicyRule)(nil),                  // 249: openshell.sandbox.v1.NetworkPolicyRule
	(*sandboxv1.L7DenyRule)(nil),                         // 250: openshell.sandbox.v1.L7DenyRule
	(*sandboxv1.L7Rule)(nil),                             // 251: openshell.sandbox.v1.L7Rule
	(*datamodelv1.Workspace)(nil),                        // 252: openshell.datamodel.v1.Workspace
	(*sandboxv1.GetSandboxConfigRequest)(nil),            // 253: openshell.sandbox.v1.GetSandboxConfigRequest
	(*sandboxv1.GetGatewayConfigRequest)(nil),            // 254: openshell.sandbox.v1.GetGatewayConfigRequest
	(*sandboxv1.GetSandboxConfigResponse)(nil),           // 255: openshell.sandbox.v1.GetSandboxConfigResponse
	(*sandboxv1.GetGatewayConfigResponse)(nil),           // 256: openshell.sandbox.v1.GetGatewayConfigResponse
}
var file_openshell_proto_depIdxs = []int32{
	...
	240, // 5: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	214, // 9: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	24,  // 10: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	241, // 11: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	...
	215, // 14: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	216, // 15: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	217, // 16: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	242, // 17: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	242, // 18: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	240, // 19: openshell.v1.SandboxWorkloadTemplate.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	242, // 22: openshell.v1.SandboxWorkloadTemplateSpec.driver_config:type_name -> google.protobuf.Struct
